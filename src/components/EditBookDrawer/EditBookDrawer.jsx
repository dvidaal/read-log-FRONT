      ...
      <Drawer>
        ...
        <DrawerContent>
          <DrawerHeader>
            ...
            <DrawerDescription>Modify the details of your book below.</DrawerDescription>
          </DrawerHeader>
          <form onSubmit={handleSubmit} className="flex flex-col w-full max-w-lg gap-4 m-auto p-6 border rounded-lg">
            ...
            <button type="submit" className="bg-green-500 text-white px-4 py-2 rounded-lg mt-4 w-40 self-center">
              Update Book
            </button>
          </form>
          <DrawerFooter>
            <DrawerClose>
              <button className="bg-red-500 text-white px-4 py-2 rounded-lg w-24 mx-auto">
                Cancel
              </button>
            </DrawerClose>
          </DrawerFooter>
